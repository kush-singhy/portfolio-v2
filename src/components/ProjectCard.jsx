    ...
    <div className="relative h-[400px] flex flex-col gap-10 px-5 pt-5 border-2 bg-[#F3F4F6] border-[#E7E8E9] rounded-2xl group overflow-hidden duration-200 hover:bg-gray-200">
        ...
        <div className="flex gap-3">
          {siteUrl && (
            <button
              ...
              className="rounded-lg border border-gray-500 px-2 py-1 flex justify-center items-center text-gray-700"
            >
              Visit Site
            </button>
          )}
      ...
      <div className="flex justify-center">
        <img
          src={imgUrl}
          alt="Noteable"
          className="w-3/4 rounded-t-xl shadow-xl absolute block top-36 group-hover:-translate-y-3 duration-200"
        />
      </div>
    </div>
  );
